...
The `ggthemes` package provides multiple predefined themes to enhance the aesthetics of plots. More styles of ggthemes can be found via [*ggplot2 Themes and Styles*](/notes/investments/ggthemes.qmd)*.*
...
More pre-built themes of hicharter can be found via [*highcharter Themes and Styles*](/notes/investments/hcthemes.qmd)*.*
