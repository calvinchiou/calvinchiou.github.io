---
title: "<lord-icon src='https://cdn.lordicon.com/vvyxyrur.json' trigger='loop' delay='1500' colors='primary:#121331,secondary:#3080e8' style='width:60px;height:60px'></lord-icon> Teaching"
format:
  html:
    include-in-header:
      text: |
